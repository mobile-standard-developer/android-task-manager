...
public class NotesDbAdapter {
	 ...
	 */
	public long createNote(String title, String body, int date_i, String date) {
	...
	public Cursor fetchAllNotes(int key, int order) {
		...
		switch (key) {
		case BY_TITLE:
			by_order = by_order + KEY_TITLE + " ";
			break;
		case BY_DATE:
			by_order = by_order + KEY_DATE_INTEGER + " ";
			break;
		case BY_ORDER:
			by_order = by_order + KEY_ROWID + " ";
			break;
		default:
			by_order = by_order + KEY_ROWID + " ";
			break;
		...
		switch (order) {
		case ASC_ORDER:
			by_order = by_order + "asc ";
			break;
		case DESC_ORDER:
			by_order = by_order + "desc ";
			break;
		default:
			by_order = by_order + "desc ";
			break;
